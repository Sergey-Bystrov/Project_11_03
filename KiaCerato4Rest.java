...
public class KiaCerato4Rest implements Methods{
    int year1;
    int year2;

    public KiaCerato4Rest(int year1, int year2) {
        this.year1 = year1;
        this.year2 = year2;
    }
    ...
    public void getMotor(){
        System.out.println(Motors.engineSize4.getMotors() + Motors.fuel1.getMotors() + Motors.motor_type1.getMotors());
